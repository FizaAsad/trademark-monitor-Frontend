...
const SCRAPERS = [
  ...
  { key: "us-states-v1", label: "US States",           subtitle: "State Registries",     endpoint: "/api/test-us-states-v1", category: "trademark"   },
  ...
  { key: "social",       label: "Social Media",        subtitle: "Instagram / TikTok",   endpoint: "/api/test-social",        category: "social"      },
];
...
const styles = {
  ...
  runAllBtn:     { padding: "10px 22px", background: "#1B2A4A", color: "#fff", border: "none", borderRadius: "6px", fontSize: "14px", fontWeight: "bold", fontFamily: "Arial, sans-serif", whiteSpace: "nowrap" },
  sectionLabel:  { fontSize: "11px", fontWeight: "bold", letterSpacing: "1px", color: "#2E5FA3", marginBottom: "14px" },
  grid:          { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "16px", marginBottom: "32px" },
  scanCard:      { background: "#fff", border: "1px solid #DDDDDD", borderRadius: "8px", overflow: "hidden", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" },
  scanCardTop:   { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 18px", gap: "12px" },
  categoryBadge: { display: "inline-block", padding: "2px 8px", borderRadius: "10px", fontSize: "10px", fontWeight: "bold", letterSpacing: "0.5px", textTransform: "uppercase", marginBottom: "6px" },
  scanCardTitle: { fontSize: "15px", fontWeight: "bold", color: "#1B2A4A", margin: "0 0 2px 0" },
  scanCardSub:   { fontSize: "12px", color: "#888", margin: 0 },
